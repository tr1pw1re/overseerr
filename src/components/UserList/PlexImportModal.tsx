...
const messages = defineMessages({
  ...
  importedfromplex:
    '<strong>{userCount}</strong> {userCount, plural, one {user} other {users}} imported from Plex successfully!',
  user: 'User',
  nouserstoimport: 'There are no users to import from Plex.',
  ...
  return (
    <Modal
      ...
      okText={intl.formatMessage(
        isImporting ? globalMessages.importing : messages.importusers
      )}
      onCancel={onCancel}
    >
      {data?.length ? (
